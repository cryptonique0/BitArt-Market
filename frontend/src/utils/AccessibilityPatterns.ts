...
export const AccessibilityPatterns = {
  ...
  keyboardNav: {
    focusClass: 'focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900',
    tabIndex: 'tabindex="0"',
...
export const ComponentDarkMode = {
  ...
  input: 'bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400',
  badge: 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300',
  button: 'bg-purple-600 dark:bg-purple-700 text-white hover:bg-purple-700 dark:hover:bg-purple-600',
